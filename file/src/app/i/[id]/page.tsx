...
interface InvoiceData {
  c: string; // companyName
  e: string; // companyEmail
  p: string; // companyPhone
  a: string; // companyAddress
  l: string; // companyLogo
  cn: string; // clientName
  ce: string; // clientEmail
  cp: string; // clientPhone
  ca: string; // clientAddress
  n: string; // invoiceNumber
  d: string; // invoiceDate
  du: string; // dueDate
  cu: string; // currency
  i: Array<{
    id: string;
  ...
  te: string; // terms
  th: string; // theme
  gtr: number; // globalTaxRate
  gdr: number; // globalDiscountRate
  gdt: 'percentage' | 'fixed'; // globalDiscountType
}
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-emerald-50 via-white to-teal-50 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-600 mb-6">The invoice you're looking for doesn't exist or has expired.</p>
          <a
    ...
    <div className="min-h-screen bg-gradient-to-br from-emerald-50 via-white to-teal-50 py-6 sm:py-12">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mt-8">
          <a
            href="/invoice-generator"
            className="bg-emerald-600 text-white px-6 py-3 rounded-lg font-medium hover:bg-emerald-700 transition-colors mr-4"
          >
