...
export default function HashGeneratorPage() {
  ...
  return (
    <>
      <Head>
        <title>Hash Generator | MD5, SHA-256, SHA-512 Online Tool - FlipFileX</title>
        <meta name="description" content="Generate secure hashes using MD5, SHA-1, SHA-256, SHA-512, and SHA-3 algorithms. Perfect for data integrity, checksums, and cryptographic applications." />
        <meta name="keywords" content="hash generator, MD5, SHA-256, SHA-512, checksum, cryptography, data integrity, secure hash" />
