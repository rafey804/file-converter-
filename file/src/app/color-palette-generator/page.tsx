...
export default function ColorPaletteGenerator() {
  ...
  return (
    <>
      <Head>
        <title>Color Palette Generator | Professional Color Schemes - FlipFileX</title>
        <meta name="description" content="Generate beautiful color palettes with professional harmony rules. Support for multiple formats, accessibility checking, and real-time preview." />
        <meta name="keywords" content="color palette generator, color scheme, harmony, complementary, triadic, analogous, hex, rgb, hsl, cmyk" />
        <link rel="canonical" href="https://flipfilex.com/color-palette-generator" />
      </Head>
