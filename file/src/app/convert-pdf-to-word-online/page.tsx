...
export default function PdfToWordPage() {
  ...
  return (
    <>
      <Head>
        <title>PDF to Word Converter - Free Online Tool | Convert PDF to DOCX</title>
        <meta name="description" content="Convert PDF to Word (DOCX) files online for free. Preserve formatting, extract text accurately, and maintain document structure. No registration required." />
        <meta name="keywords" content="PDF to Word, PDF to DOCX, convert PDF, extract text from PDF, PDF converter, document conversion" />
        <meta property="og:title" content="PDF to Word Converter - Free & Accurate" />
        <meta property="og:description" content="Transform your PDF documents into editable Word files while preserving formatting and layout." />
