...
export default function ImageCompressorPage() {
  ...
  return (
    <>
      <Head>
        <title>Free Image Compressor - Reduce Image File Size by 90% | Online Image Optimizer</title>
        <meta name="description" content="Compress images online for free. Reduce JPEG, PNG, WebP file sizes by up to 90% while maintaining quality. Professional image compression tool with live preview and secure processing." />
        <meta name="keywords" content="image compressor, compress images online, reduce image size, image optimizer, JPEG compression, PNG compression, WebP compression, free image tools" />
        <meta name="robots" content="index, follow" />
        <meta property="og:title" content="Free Image Compressor - Reduce Image File Size by 90%" />
        <meta property="og:description" content="Professional image compression tool. Compress JPEG, PNG, WebP images online for free with live preview and up to 90% size reduction." />
        <meta property="og:type" content="website" />
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content="Free Image Compressor - Reduce Image File Size by 90%" />
        <meta name="twitter:description" content="Compress images online for free. Professional tool with live preview and secure processing." />
        ...
        <div className="mt-12 sm:mt-16">
          <div className="bg-gradient-to-br from-orange-50 via-red-50 to-pink-50 rounded-2xl sm:rounded-3xl p-6 sm:p-8 lg:p-10 border border-orange-200">
            <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-6 text-center">
              Professional Image Compression for Every Need
            </h2>

            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
              <div>
                <h3 className="text-xl font-semibold text-gray-900 mb-4">Why Image Compression Matters</h3>
                <p className="text-gray-700 leading-relaxed mb-4">
                  In today's digital world, image optimization is crucial for website performance, storage efficiency, and user experience.
                  Large image files slow down websites, consume bandwidth, and impact SEO rankings. Our advanced image compressor solves
                  these problems by reducing file sizes dramatically while maintaining visual quality.
                </p>
                <p className="text-gray-700 leading-relaxed">
                  Whether you're optimizing images for web development, reducing storage costs, improving page load speeds, or sharing
                  high-quality photos efficiently, our tool provides professional-grade compression with intuitive controls and instant results.
                </p>
              </div>

              <div>
                <h3 className="text-xl font-semibold text-gray-900 mb-4">Use Cases & Applications</h3>
                <ul className="space-y-2 text-gray-700">
                  <li className="flex items-start">
                    <span className="text-orange-500 mr-2 mt-1">•</span>
                    <span><strong>Web Development:</strong> Optimize images for faster loading websites and better SEO</span>
                  </li>
                  <li className="flex items-start">
                    <span className="text-orange-500 mr-2 mt-1">•</span>
                    <span><strong>E-commerce:</strong> Reduce product image sizes while maintaining quality for online stores</span>
                  </li>
                  <li className="flex items-start">
                    <span className="text-orange-500 mr-2 mt-1">•</span>
                    <span><strong>Social Media:</strong> Compress images for faster uploads and better engagement</span>
                  </li>
                  <li className="flex items-start">
                    <span className="text-orange-500 mr-2 mt-1">•</span>
                    <span><strong>Email Marketing:</strong> Reduce email sizes with compressed images for better deliverability</span>
                  </li>
                  <li className="flex items-start">
                    <span className="text-orange-500 mr-2 mt-1">•</span>
                    <span><strong>Mobile Apps:</strong> Optimize image assets for faster app performance</span>
                  </li>
                  <li className="flex items-start">
                    <span className="text-orange-500 mr-2 mt-1">•</span>
                    <span><strong>Cloud Storage:</strong> Save storage space and bandwidth costs</span>
                  </li>
                </ul>
              </div>
            </div>
            ...
            <div className="mt-8 text-center">
              <p className="text-gray-700 leading-relaxed">
                Start compressing your images today and experience the perfect balance of file size reduction and visual quality.
                Our advanced algorithms ensure optimal results for any image type, from high-resolution photography to web graphics
                and everything in between. Join thousands of users who trust our tool for their image optimization needs.
              </p>
            </div>
          </div>
        </div>
