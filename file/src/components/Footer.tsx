      ...
      <div className="relative max-w-6xl mx-auto px-3 sm:px-4 lg:px-6 py-12">
        <div className="grid grid-cols-1 lg:grid-cols-7 gap-6">
          ...
          <div>
            ...
            {/* Quick Access */}
            <div className="mt-4">
              <h4 className="text-xs font-semibold text-slate-400 mb-2">QUICK ACCESS</h4>
              <div className="space-y-1">
                <Link href="/tools" className="block text-xs text-slate-400 hover:text-white transition-colors">
                  🔧 All Tools
                </Link>
                <Link href="/api" className="block text-xs text-slate-400 hover:text-white transition-colors">
                  🔌 API Access
                </Link>
                <Link href="/enterprise" className="block text-xs text-slate-400 hover:text-white transition-colors">
                  🏢 Enterprise
                </Link>
              </div>
            </div>
