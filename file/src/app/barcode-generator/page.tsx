...
export default function BarcodeGeneratorPage() {
  ...
  return (
    <>
      <Head>
        <title>Barcode Generator | Create EAN, UPC, Code 128 Barcodes - FlipFileX</title>
        <meta name="description" content="Generate professional barcodes in multiple formats: EAN-13, UPC-A, Code 128, Code 39, and more. Perfect for retail, inventory, and shipping applications." />
        <meta name="keywords" content="barcode generator, EAN-13, UPC-A, Code 128, Code 39, retail barcode, inventory barcode, shipping label" />
