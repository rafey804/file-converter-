    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-indigo-50">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-20">
          ...
          <div className="flex justify-center space-x-4 animate-slide-up delay-300">
            <div className="px-6 py-2 bg-blue-100 text-blue-800 rounded-full text-sm font-semibold animate-pulse">
              {imageConverters.length + videoConverters.length + audioConverters.length + fontConverters.length + pdfConverters.length + utilityTools.length}+ Tools
            </div>
        ...
        {filteredUtilityTools.length > 0 && (
          <section id="utility-tools" className="mb-20 animate-slide-up delay-500">
        ...
        {searchTerm && filteredImageConverters.length === 0 && filteredVideoConverters.length === 0 &&
         filteredAudioConverters.length === 0 && filteredFontConverters.length === 0 && filteredPdfConverters.length === 0 && filteredUtilityTools.length === 0 && (
        ...
        <section className="bg-white/80 backdrop-blur-sm rounded-2xl p-8 shadow-2xl border border-gray-100/50 text-center mb-16 animate-slide-up delay-500">
          <div className="grid md:grid-cols-6 gap-8">
            <div className="group hover:scale-105 transition-all duration-300">
              ...
              <div className="text-gray-600 group-hover:text-blue-600 transition-colors">Image Converters</div>
            </div>
            <div className="group hover:scale-105 transition-all duration-300">
              ...
              <div className="text-gray-600 group-hover:text-red-600 transition-colors">Video Converters</div>
            </div>
            <div className="group hover:scale-105 transition-all duration-300">
              ...
              <div className="text-gray-600 group-hover:text-purple-600 transition-colors">Audio Converters</div>
            </div>
            <div className="group hover:scale-105 transition-all duration-300">
              ...
              <div className="text-gray-600 group-hover:text-slate-600 transition-colors">Font Converters</div>
            </div>
            <div className="group hover:scale-105 transition-all duration-300">
              ...
              <div className="text-gray-600 group-hover:text-green-600 transition-colors">PDF Tools</div>
            </div>
            <div className="group hover:scale-105 transition-all duration-300">
              ...
              <div className="text-gray-600 group-hover:text-indigo-600 transition-colors">Utility Tools</div>
            </div>
          </div>
        </section>
        ...
        <section className="text-center bg-gradient-to-r from-blue-600 via-purple-600 to-pink-600 rounded-3xl p-12 shadow-2xl animate-slide-up delay-1100">
          <div className="text-white">
            ...
            <p className="text-xl mb-8 text-blue-100">
              Choose from {imageConverters.length + videoConverters.length + audioConverters.length + fontConverters.length + pdfConverters.length + utilityTools.length}+ conversion tools and start converting now!
            </p>
            <div className="flex flex-wrap justify-center gap-4">
              <a href="#image-converters" className="bg-white text-blue-600 px-8 py-4 rounded-xl font-bold text-lg hover:bg-gray-100 transform hover:scale-105 transition-all duration-300 shadow-lg">
                Convert Images
              </a>
              <a href="#video-converters" className="bg-white text-red-600 px-8 py-4 rounded-xl font-bold text-lg hover:bg-gray-100 transform hover:scale-105 transition-all duration-300 shadow-lg">
                Convert Videos
              </a>
              <a href="#audio-converters" className="bg-white text-purple-600 px-8 py-4 rounded-xl font-bold text-lg hover:bg-gray-100 transform hover:scale-105 transition-all duration-300 shadow-lg">
                Convert Audio
              </a>
              <a href="#font-converters" className="bg-white text-slate-600 px-8 py-4 rounded-xl font-bold text-lg hover:bg-gray-100 transform hover:scale-105 transition-all duration-300 shadow-lg">
                Convert Fonts
              </a>
              <a href="#pdf-converters" className="bg-white text-green-600 px-8 py-4 rounded-xl font-bold text-lg hover:bg-gray-100 transform hover:scale-105 transition-all duration-300 shadow-lg">
                Convert PDFs
              </a>
              <a href="#utility-tools" className="bg-white text-indigo-600 px-8 py-4 rounded-xl font-bold text-lg hover:bg-gray-100 transform hover:scale-105 transition-all duration-300 shadow-lg">
                Utility Tools
              </a>
            </div>
          </div>
        ...
        <section className="text-center py-12 animate-slide-up delay-1200">
          <div className="text-gray-600">
            ...
            <p className="text-sm">
              Supporting {imageConverters.length + videoConverters.length + audioConverters.length + fontConverters.length + pdfConverters.length + utilityTools.length}+ conversion formats |
