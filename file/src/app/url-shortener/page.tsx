...
export default function URLShortenerPage() {
  ...
  return (
    <>
      <Head>
        <title>Free URL Shortener | Create Short Links - FlipFileX</title>
        <meta name="description" content="Free URL shortener to create short links for social media, emails, and marketing. Custom aliases, click tracking, and permanent URLs. No registration required." />
        <meta name="keywords" content="URL shortener, short links, link shortener, tiny URL, custom links, click tracking, social media links" />
        <link rel="canonical" href="https://flipfilex.com/url-shortener" />
      </Head>
