            ...
            <div className="mt-10 pt-8 border-t border-gray-200">
              <div className="bg-gradient-to-r from-emerald-50 to-teal-50 rounded-xl p-6 sm:p-8">
                ...
                <p className="text-gray-700 leading-relaxed mb-4">
                  Create stunning, professional invoices that reflect your brand's quality and attention to detail. Our invoice generator combines ease of use with powerful features, making it perfect for freelancers, consultants, small businesses, and enterprises who need to create invoices quickly and professionally.
                </p>
                <p className="text-gray-700 leading-relaxed mb-4">
                  With automatic calculations, multiple currency support, customizable themes, and seamless export options, you can focus on your business while we handle the invoice creation. Generate unlimited invoices with no restrictions, watermarks, or hidden costs.
                </p>
                <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 mt-6">
                  ...
                  <div className="text-center">
                    ...
                    <div className="text-sm text-gray-600">Currency Options</div>
                  </div>
                  <div className="text-center">
                    <div className="text-2xl font-bold text-emerald-600">5</div>
                    <div className="text-sm text-gray-600">Color Themes</div>
                  </div>
                  <div className="text-center">
