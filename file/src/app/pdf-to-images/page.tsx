...
export default function PdfToImagesPage() {
  ...
  const acceptedTypes = getAcceptedFileTypes('pdf-to-images');
  ...
  return (
    <>
      <Head>
        <title>PDF to Images Converter - Free Online Tool | Convert PDF Pages to PNG</title>
        <meta name="description" content="Convert PDF pages to high-quality PNG images for free. Extract all pages as individual images with 300 DPI quality. Download as ZIP file." />
        <meta name="keywords" content="PDF to images, PDF to PNG, extract PDF pages, PDF page converter, PDF image extractor" />
        <meta property="og:title" content="PDF to Images Converter - Extract PDF Pages as Images" />
        <meta property="og:description" content="Convert PDF pages to high-quality images instantly. Perfect for presentations and web use." />
        <link rel="canonical" href="https://yoursite.com/pdf-to-images" />
      </Head>
