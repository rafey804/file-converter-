...
export default function Base64EncoderDecoderPage() {
  ...
  return (
    <>
      <Head>
        <title>Base64 Encoder Decoder | Online Text & File Converter - FlipFileX</title>
        <meta name="description" content="Encode and decode Base64 text and files online. Fast, secure, and free Base64 converter with file support and batch processing." />
        <meta name="keywords" content="base64 encoder, base64 decoder, online converter, text encoding, file encoding, base64 tool" />
