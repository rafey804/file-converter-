        ...
        <div className="mt-12 sm:mt-16">
          <div className="bg-white rounded-2xl sm:rounded-3xl shadow-2xl p-6 sm:p-8 lg:p-10 border border-gray-100">
            ...
            <div className="mt-10 pt-8 border-t border-gray-200">
              <div className="bg-gradient-to-r from-purple-50 to-blue-50 rounded-xl p-6 sm:p-8">
                <h3 className="text-xl font-bold text-gray-900 mb-4">
                  Professional QR Code Generator for All Your Needs
                </h3>
                <p className="text-gray-700 leading-relaxed mb-4">
                  Our advanced QR code generator offers enterprise-grade features with an intuitive interface. Whether you're creating QR codes for marketing campaigns, business cards, event tickets, restaurant menus, or educational materials, our tool provides the flexibility and reliability you need.
                </p>
                <p className="text-gray-700 leading-relaxed mb-4">
                  Generate QR codes instantly with live preview, multiple format support, and extensive customization options. Perfect for businesses, marketers, educators, and individuals who need professional-quality QR codes without the complexity or cost of premium tools.
                </p>
