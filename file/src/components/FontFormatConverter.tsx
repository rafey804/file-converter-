                ...
                <div className="mt-8">
                  ...
                  <div className="mt-6 text-center">
                    <button
                      ...
                      className="bg-gradient-to-r from-slate-600 to-zinc-600 text-white px-8 py-3 rounded-xl font-semibold text-lg
                               hover:from-slate-700 hover:to-zinc-700 transition-all duration-300 shadow-lg hover:shadow-xl
