          ...
          {files.length > 0 && (
            <div ref={compressButtonRef} className="text-center mb-8">
              <button
                ...
                className="bg-gradient-to-r from-emerald-600 to-teal-600 text-white px-12 py-4 rounded-2xl font-bold text-xl
                         hover:from-emerald-700 hover:to-teal-700 transition-all duration-300 shadow-2xl hover:shadow-3xl
