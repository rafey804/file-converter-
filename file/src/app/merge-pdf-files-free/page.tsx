...
export default function MergePdfPage() {
  ...
  return (
    <>
      <Head>
        <title>Merge PDF Files - Free Online PDF Merger Tool | Combine Multiple PDFs</title>
        <meta name="description" content="Merge multiple PDF files into one document for free. Combine up to 10 PDFs while preserving quality and formatting. No registration required." />
        <meta name="keywords" content="merge PDF, combine PDF, PDF merger, join PDF files, PDF combiner, multiple PDF merge" />
        <meta property="og:title" content="PDF Merger - Combine Multiple PDFs for Free" />
        <meta property="og:description" content="Easily merge multiple PDF files into a single document with our free online tool." />
        <link rel="canonical" href="https://flipfilex.com/merge-pdf" />
      </Head>
