...
export default function SEOOptimizedImageConverter({ 
  ...
  const updateConversionType = (newFrom: string, newTo: string) => {
    ...
    const validation = validateConversion(newFrom, newTo);
    if (!validation.valid) {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-purple-50 via-white to-indigo-50">
      <Head>
        ...
        <link rel="canonical" href={`https://yoursite.com/${sourceFormat}-to-${targetFormat}`} />
      </Head>
            ...
            {targetFormat === 'svg' && (
              <div className="mb-8 p-4 bg-blue-50 border border-blue-200 rounded-lg">
                <p className="text-sm text-blue-800 flex items-center">
                  <svg className="w-4 h-4 mr-2" fill="currentColor" viewBox="0 0 20 20">
                    <path fillRule="evenodd" d="M18 10a8 8 0 100-16 8 8 0 000 16zm7-9A1 1 0 1013 9v4a1 1 0 11-2 0V9a1 1 0 011-1z" clipRule="evenodd" />
                  </svg>
